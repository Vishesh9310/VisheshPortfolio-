...
//   return (
//     <nav className="fixed top-0 left-0 w-full bg-gray-900 shadow-md z-50 h-14">
...
//           <li><button onClick={toggleTheme}> {theme === "light" ? <FaMoon className="text-white" /> : <FaSun className="text-white" />}</button></li>
//         </ul>
//         <div className="bx bx-menu hidden sm:block md:block lg:hidden w-fit content-center" id="menu-icon">
//           hello
//         </div>
//       </div>
//     </nav>
