      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 px-4">
        ...
        <div>
          ...
          <ul className="text-sm space-y-1">
            <li><a href="#about" onClick={(e) => handleAboutClick(e, "about")} className="hover:text-white transition-colors"> About</a></li>
            <li><NavLink to="/projects" className="hover:text-white transition-colors">Projects</NavLink></li>
            <li><a href="#skills" onClick={(e) => handleAboutClick(e, "skills")} className="hover:text-white transition-colors"> Skills</a></li>
            <li><a href="#education" onClick={(e) => handleAboutClick(e, "education")} className="hover:text-white transition-colors"> Education</a></li>
          ...
          <div>
            ...
            <ul className="text-sm space-y-1">
              ...
              <li>Email:{' '}
                <a href="mailto:vk866797@gmail.com" target="_blank" rel="noreferrer" className="hover:text-white">  vk866797@gmail.com</a>
              </li>
          ...
          <div>
            ...
            <div className="flex gap-5 mt-2">
              <a href="https://github.com/Vishesh9310" className='text-3xl text-white' target="_blank" rel="noreferrer"><FaGithub /> </a>
